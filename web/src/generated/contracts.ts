...
export interface ManualSubtitleSelection {
  "targetPath": string;
  "subtitlePath": string;
}
...
export interface MuxPreviewRequest {
  ...
  "remuxOutputSuffix": string;
  "muxMatchingExternalSubtitles": boolean;
  "manualSubtitleSelections": Array<ManualSubtitleSelection>;
...
export interface PropEditPreviewRequest {
  ...
  "videoTrackLanguage"?: string | null;
  "selectedDefaultVideo": string;
...
export interface PropEditTrackConfigRow {
  ...
  "nameFromChannels"?: boolean | null;
  "nameFromCodecChannels"?: boolean | null;
...
export interface WebSettingsRequest {
  ...
  "libraryRoots"?: Array<SourceRoot> | null;
...
export interface ContractTypes {
  ...
  LogLevel: LogLevel;
  LogQuery: LogQuery;
  ManualSubtitleSelection: ManualSubtitleSelection;
...
export const contractSchemas: Record<ContractName, ContractSchema> = {
  ...
  LibraryAuditRequest: { kind: "object", fields: { "paths": { optional: false, schema: { kind: "array", item: { kind: "string" } } }, "files": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "MediaFileRow" } } } }, flatten: [] },
  ...
  ManualSubtitleSelection: { kind: "object", fields: { "targetPath": { optional: false, schema: { kind: "string" } }, "subtitlePath": { optional: false, schema: { kind: "string" } } }, flatten: [] },
  ...
  MuxPreviewRequest: { kind: "object", fields: { "files": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "MediaFileRow" } } }, "selectedPaths": { optional: false, schema: { kind: "array", item: { kind: "string" } } }, "removeUnwantedAudioLanguages": { optional: false, schema: { kind: "boolean" } }, "keepAudioLanguages": { optional: false, schema: { kind: "string" } }, "removeUnwantedSubtitleLanguages": { optional: false, schema: { kind: "boolean" } }, "keepSubtitleLanguages": { optional: false, schema: { kind: "string" } }, "removeUnwantedTrackIds": { optional: false, schema: { kind: "boolean" } }, "removeTrackIdsText": { optional: false, schema: { kind: "string" } }, "preserveChapters": { optional: false, schema: { kind: "boolean" } }, "preserveAttachments": { optional: false, schema: { kind: "boolean" } }, "preserveOriginal": { optional: false, schema: { kind: "boolean" } }, "remuxOutputSuffix": { optional: false, schema: { kind: "string" } }, "muxMatchingExternalSubtitles": { optional: false, schema: { kind: "boolean" } }, "manualSubtitleSelections": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "ManualSubtitleSelection" } } }, "externalSubtitleLanguage": { optional: false, schema: { kind: "string" } }, "externalSubtitleTrackName": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "externalSubtitleFormats": { optional: false, schema: { kind: "string" } }, "preserveExternalSubtitleFiles": { optional: false, schema: { kind: "boolean" } }, "skipMuxIfSubtitleAlreadyExists": { optional: false, schema: { kind: "boolean" } }, "extractSubtitles": { optional: false, schema: { kind: "boolean" } }, "extractSubtitleLanguages": { optional: false, schema: { kind: "string" } }, "extractOverwriteExistingFiles": { optional: false, schema: { kind: "boolean" } }, "convertMp4ToMkv": { optional: false, schema: { kind: "boolean" } }, "deleteMp4AfterConvert": { optional: false, schema: { kind: "boolean" } }, "planId": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "planFingerprint": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "idempotencyKey": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } } }, flatten: [] },
  ...
  PropEditPreviewRequest: { kind: "object", fields: { "files": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "MediaFileRow" } } }, "selectedPaths": { optional: false, schema: { kind: "array", item: { kind: "string" } } }, "templatePath": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "containerTitleMode": { optional: false, schema: { kind: "ref", name: "TitleEditMode" } }, "customContainerTitle": { optional: false, schema: { kind: "string" } }, "videoTitleMode": { optional: false, schema: { kind: "ref", name: "TitleEditMode" } }, "customVideoTitle": { optional: false, schema: { kind: "string" } }, "videoTrackLanguage": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "selectedDefaultVideo": { optional: false, schema: { kind: "string" } }, "audioTracks": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "PropEditTrackConfigRow" } } }, "subtitleTracks": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "PropEditTrackConfigRow" } } }, "selectedDefaultAudio": { optional: false, schema: { kind: "string" } }, "selectedForcedAudio": { optional: false, schema: { kind: "string" } }, "selectedDefaultSubtitle": { optional: false, schema: { kind: "string" } }, "selectedForcedSubtitle": { optional: false, schema: { kind: "string" } }, "planId": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "planFingerprint": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } }, "idempotencyKey": { optional: true, schema: { kind: "union", variants: [{ kind: "string" }, { kind: "null" }] } } }, flatten: [] },
  ...
  PropEditTrackConfigRow: { kind: "object", fields: { "trackNumber": { optional: false, schema: { kind: "number", integer: true, unsigned: true } }, "trackLabel": { optional: false, schema: { kind: "string" } }, "type": { optional: false, schema: { kind: "string" } }, "currentName": { optional: false, schema: { kind: "string" } }, "currentLanguage": { optional: false, schema: { kind: "string" } }, "currentCodec": { optional: false, schema: { kind: "string" } }, "currentChannels": { optional: false, schema: { kind: "union", variants: [{ kind: "number", integer: true, unsigned: true }, { kind: "null" }] } }, "currentDefault": { optional: false, schema: { kind: "boolean" } }, "editedName": { optional: false, schema: { kind: "string" } }, "nameFromMetadata": { optional: false, schema: { kind: "boolean" } }, "nameFromChannels": { optional: true, schema: { kind: "union", variants: [{ kind: "boolean" }, { kind: "null" }] } }, "nameFromCodecChannels": { optional: true, schema: { kind: "union", variants: [{ kind: "boolean" }, { kind: "null" }] } }, "editedLanguage": { optional: false, schema: { kind: "string" } } }, flatten: [] },
