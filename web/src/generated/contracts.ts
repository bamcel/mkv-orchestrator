...
export const contractSchemas: Record<ContractName, ContractSchema> = {
  ...
  LibraryAuditRequest: { kind: "object", fields: { "files": { optional: false, schema: { kind: "array", item: { kind: "ref", name: "MediaFileRow" } } }, "sourcePaths": { optional: false, schema: { kind: "array", item: { kind: "string" } } } }, flatten: [] },
