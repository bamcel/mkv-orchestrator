...
`contracts.ts` is generated from the serde-annotated Rust DTOs in `crates/mkvo-contracts`. It currently contains 69 boundary DTOs and 24 referenced domain enums. It also includes zero-dependency runtime validators.
